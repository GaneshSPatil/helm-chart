...
```bash
$ helm3 repo add gocd_repo https://gocd.github.io/helm-chart
$ helm3 search repo gocd_repo
$ helm3 install gocd_app gocd_repo/gocd
```
...
> **Tip**: List all releases using `helm3 search repo gocd_repo`
